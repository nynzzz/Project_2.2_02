...
import chatbot.project22.CYKParser.CYKAlgorithm;
...
public class ChatScreencyk extends Application{
...
//                String responseText = textFileBot.generateResponse(messageText);
                ...
                String filePath = "src/main/java/chatbot/project22/CYKParser/CYK_rules.txt";
                ...
                String responseText = cykAlgorithm.CYKAlgorithm(messageText);
